    ...
    const ParamMapType& paramMap)
{
    ...
    const double minAngle = (paramMinAngleIt != paramMap.end()) ?
        std::stod(paramMinAngleIt->second) : (-PiHalf<double>);
...
double CarmenLogReader::GuessAngleRange(int numReadings)
{
    switch (numReadings) {
        case 181:
            return Pi<double>;
        case 180:
            return Pi<double> * 179.0 / 180.0;
        case 361:
            return Pi<double>;
        case 360:
            return Pi<double> * 179.5 / 180.0;
        case 401:
            return Pi<double> * 100.0 / 180.0;
        case 400:
            return Pi<double> * 99.75 / 180.0;
        default:
            return Pi<double>;
    }
}
...
double CarmenLogReader::GuessAngleIncrement(int numReadings)
{
    switch (numReadings) {
        ...
        case 180:
            return Pi<double> / 180.0;
        case 361:
            return Pi<double> / 360.0;
        case 360:
            return Pi<double> / 360.0;
        case 401:
            return Pi<double> / 720.0;
        case 400:
            return Pi<double> / 720.0;
        default:
